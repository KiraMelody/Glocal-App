...
class ContactTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.searchController.searchBar.tintColor = ColorandFontTable.lightGreen
        self.searchController.searchBar.barTintColor = UIColor.white
        self.searchController.searchBar.backgroundColor = ColorandFontTable.groundGreen
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        title.textColor = ColorandFontTable.lightGreen
        title.font = ColorandFontTable.usualFont
        ground.addSubview(title)
        ground.backgroundColor = ColorandFontTable.groundGreen
    ...
    {
        let avc = ContactTableViewController()
        self.navigationController?.pushViewController(avc, animated: true)
    }
